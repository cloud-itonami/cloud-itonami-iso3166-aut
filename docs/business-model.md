# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Austria

## Classification

- Repository: `cloud-itonami-iso3166-aut`
- ISO 3166: `AUT` (Austria)
...
- an already-incorporated `cloud-itonami-cofog-{code}` /
  ...
  `cloud-itonami-{ISIC}` operator wanting to bid on a Austrian
  public contract
...
- registration walkthrough for the USP (Unternehmensserviceportal, usp.gv.at) eProcurement search under BVergG 2018, with federal central purchasing via BBG (Bundesbeschaffung GmbH)
- business/tax registration checklist: Firmenbuch commercial-register extract plus UID (Umsatzsteuer-Identifikationsnummer) via FinanzOnline / USP
- local-content / preferential-procurement navigation: EU member state — no national-content quota; EU single-market access applies alongside USP/BBG registration
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Austrian-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in Austria).
