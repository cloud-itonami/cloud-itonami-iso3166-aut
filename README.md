# cloud-itonami-iso3166-aut

Open ISO 3166 Blueprint for **AUT**: Austria.
...
tax registration, and local-content rules in Austria, so the operator
...
- **Not the government of Austria.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Austrian-licensed counsel
...
(ISO 3166 `AUT`). Required capabilities:
